...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/lomba_pendaftar', [LombaPesertaController::class, 'data'])->name('admin.lomba_pendaftar.data');
    Route::get('/lomba_pendaftar/data/{id}/detail', [LombaPesertaController::class, 'detail'])->name('admin.lomba_pendaftar.detail');
    Route::get('/lomba_pendaftar/data/{id}/edit', [LombaPesertaController::class, 'edit'])->name('admin.lomba_pendaftar.edit');
    Route::put('/lomba_pendaftar/data/{id}', [LombaPesertaController::class, 'update'])->name('admin.lomba_pendaftar.update');
